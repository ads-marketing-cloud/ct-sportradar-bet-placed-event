...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Sportradar Bet Placed Template",
  ...
  "description": "Sportradar Bet Placed Template",
  "containerContexts": [
    "WEB"
  ]
}
...
callInWindow('srtmCommands.push', {
  ...
  payload: {
    ...
    contentIds: makeString(data.contentIds).split(','),
  },
});
